...
class InstanceApi(object):
    ...
    def __init__(self,  req_wrapper=None):
        ...
        self.si_uuid = None
        self._allowed_actions = ['provision', 'cancel', 'reprovision', 'propagate', 'commit', 'release', 'reinstate', 'verify']
    ...
    def instance_operate(self, action, **kwargs):  # noqa: E501
        ...
        if action not in self._allowed_actions:
            raise ValueError(f'operate action must of one of {self._allowed_actions}')
    ...
    def instance_si_uuid_action_put_with_http_info(self, si_uuid, action, **kwargs):  # noqa: E501
        ...
        return self.client.request('PUT', '/instance/' + si_uuid + '/' + action, query_params=query_params)
    ...
    def instance_create(self, intent, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.instance_si_uuid_post_with_http_info(intent, si_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.instance_si_uuid_post_with_http_info(intent, si_uuid, **kwargs)  # noqa: E501
            return data
    ...
    def instance_modify(self, intent, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.instance_si_uuid_modify_post_with_http_info(intent, si_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.instance_si_uuid_modify_post_with_http_info(intent, si_uuid, **kwargs)  # noqa: E501
            return data

    def instance_si_uuid_modify_post_with_http_info(self, body, si_uuid, **kwargs):  # noqa: E501
        """Create new service instance and/or add new intent  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method instance_si_uuid_modify_post_with_http_info" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `instance_modify`")  # noqa: E501
        # verify the required parameter 'si_uuid' is set
        if ('si_uuid' not in params or
                params['si_uuid'] is None):
            raise ValueError(
                "Missing the required parameter `si_uuid` when calling `instance_modify`")  # noqa: E501
    ...
    def instance_get_status(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.instance_si_uuid_status_get_with_http_info(si_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.instance_si_uuid_status_get_with_http_info(si_uuid, **kwargs)  # noqa: E501
            return data

    def instance_si_uuid_status_get_with_http_info(self, si_uuid, **kwargs):  # noqa: E501
        """Get instance status  # noqa: E501
        Retrieves the full instance status.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        if ('si_uuid' not in params or
                params['si_uuid'] is None):
            raise ValueError("Missing the required parameter `si_uuid` when calling `instance_si_uuid_status_get`")  # noqa: E501

        return self.client.request(
            'GET', f'/instance/{si_uuid}/status')
    ...
    def instance_get_substatus(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.instance_si_uuid_substatus_get_with_http_info(si_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.instance_si_uuid_substatus_get_with_http_info(si_uuid, **kwargs)  # noqa: E501
            return data

    def instance_si_uuid_substatus_get_with_http_info(self, si_uuid, **kwargs):  # noqa: E501
        """Get instance status  # noqa: E501
        Retrieves the full instance status.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        if ('si_uuid' not in params or
                params['si_uuid'] is None):
            raise ValueError("Missing the required parameter `si_uuid` when calling `instance_get_substatus`")  # noqa: E501

        return self.client.request(
            'GET', f'/instance/{si_uuid}/substatus')
    ...
    def instance_set_superstate(self, state, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.instance_si_uuid_superstate_put_with_http_info(si_uuid, state, **kwargs)  # noqa: E501
        else:
            (data) = self.instance_si_uuid_superstate_put_with_http_info(si_uuid, state, **kwargs)  # noqa: E501
            return data

    def instance_si_uuid_superstate_put_with_http_info(self, si_uuid, state, **kwargs):  # noqa: E501
        """Get instance status  # noqa: E501
        Retrieves the full instance status.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        if ('si_uuid' not in params or
                params['si_uuid'] is None):
            raise ValueError("Missing the required parameter `si_uuid` when calling `instance_set_superstate`")  # noqa: E501
        if ('state' not in params or
                params['state'] is None):
            raise ValueError(
                "Missing the required parameter `state` when calling `instance_set_superstate`")  # noqa: E501

        return self.client.request(
            'PUT', f'/instance/{si_uuid}/superstate/{state}')
