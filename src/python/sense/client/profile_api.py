...
class ProfileApi(object):
    ...
    def profile_post_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        return self.client.request(
            'POST', f'/profile', body_params=body_params)
    ...
    def profile_add_licenses(self, body, uuid, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.profile_uuid_licenses_post_with_http_info(body, uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.profile_uuid_licenses_post_with_http_info(body, uuid, **kwargs)  # noqa: E501
            return data

    def profile_uuid_licenses_post_with_http_info(self, body, uuid, **kwargs):  # noqa: E501
        """Add new license  # noqa: E501
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `profile_uuid_licenses_post`")  # noqa: E501
        # verify the required parameter 'uuid' is set
        if ('uuid' not in params or
                params['uuid'] is None):
            raise ValueError("Missing the required parameter `uuid` when calling `profile_uuid_licenses_post`")  # noqa: E501
        ...
        return self.client.request(
            'POST', f'/profile/{uuid}/licenses', body_params=body_params)
    ...
    def profile_update_licenses(self, body, uuid, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.profile_uuid_licenses_put_with_http_info(body, uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.profile_uuid_licenses_put_with_http_info(body, uuid, **kwargs)  # noqa: E501
            return data

    def profile_uuid_licenses_put_with_http_info(self, body, uuid, **kwargs):  # noqa: E501
        """Edit existing license  # noqa: E501
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `profile_uuid_licenses_put`")  # noqa: E501
        # verify the required parameter 'uuid' is set
        if ('uuid' not in params or
                params['uuid'] is None):
            raise ValueError("Missing the required parameter `uuid` when calling `profile_uuid_licenses_put`")  # noqa: E501
        ...
        return self.client.request(
            'PUT', f'/profile/{uuid}/licenses', body_params=body_params)
    ...
    def profile_update(self, body, uuid, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.profile_uuid_put_with_http_info(body, uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.profile_uuid_put_with_http_info(body, uuid, **kwargs)  # noqa: E501
            return data

    def profile_uuid_put_with_http_info(self, body, uuid, **kwargs):  # noqa: E501
        """Edit a profile  # noqa: E501
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `profile_uuid_put`")  # noqa: E501
        # verify the required parameter 'uuid' is set
        if ('uuid' not in params or
                params['uuid'] is None):
            raise ValueError("Missing the required parameter `uuid` when calling `profile_uuid_put`")  # noqa: E501
        ...
        return self.client.request(
            'PUT', f'/profile/{uuid}', body_params=body_params)
    ...
    def profile_get_uses(self, uuid, username, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.profile_uuid_uses_username_get_with_http_info(uuid, username, **kwargs)  # noqa: E501
        else:
            (data) = self.profile_uuid_uses_username_get_with_http_info(uuid, username, **kwargs)  # noqa: E501
            return data

    def profile_uuid_uses_username_get_with_http_info(self, uuid, username, **kwargs):  # noqa: E501
        """Get license usage  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method profile_uuid_uses_username_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'uuid' is set
        if ('uuid' not in params or
                params['uuid'] is None):
            raise ValueError("Missing the required parameter `uuid` when calling `profile_uuid_uses_username_get`")  # noqa: E501
        # verify the required parameter 'username' is set
        if ('username' not in params or
                params['username'] is None):
            raise ValueError("Missing the required parameter `username` when calling `profile_uuid_uses_username_get`")  # noqa: E501
        ...
        return self.client.request(
            'GET', f'/profile/{uuid}/uses/{username}')
