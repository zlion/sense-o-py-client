...
class WorkflowPhasedApi(object):
    ...
    def __init__(self, req_wrapper=None):
        ...
        self._allowed_actions = ['propagate', 'commit', 'release', 'reinstate', 'verify']
    ...
    def instance_si_uuid_status_get_with_http_info(self, si_uuid, **kwargs):  # noqa: E501
        ...
        if ('si_uuid' not in params or
                params['si_uuid'] is None):
            raise ValueError(
                "Missing the required parameter `si_uuid` when calling `instance_si_uuid_status_get`")  # noqa: E501
    ...
    def instance_verify(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.instance_si_uuid_verify_get_with_http_info(si_uuid, **kwargs)  # noqa: E501
        else:
            (data) = self.instance_si_uuid_verify_get_with_http_info(si_uuid, **kwargs)  # noqa: E501
            return data

    def instance_si_uuid_verify_get_with_http_info(self, si_uuid, **kwargs):  # noqa: E501
        """Retrieve verification data  # noqa: E501
        Requests the data from the last or current verification run.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        if ('si_uuid' not in params or
                params['si_uuid'] is None):
            raise ValueError(
                "Missing the required parameter `si_uuid` when calling `instance_si_uuid_verify_get`")  # noqa: E501


        return self.client.request(
            'GET', f'/instance/{self.si_uuid}/verify')